...
we turn your answers into one evolving playlist.</p>
        ...
        <div className="text-center bg-gradient-to-r from-purple-600 to-blue-600 rounded-2xl p-12" >
          ...
          <Button className="bg-white text-purple-600 hover:bg-gray-100 px-8 py-3 rounded-sm font-semibold transition-all duration-300 hover:scale-105" onClick={() => window.open("https://t.me/prubasti_bot", "_blank")}>
            Start Now
          </Button>
        </div>
      </div>
